...
@Destination
@Composable
fun CornerBowfrontCalculator(
    navigator: DestinationsNavigator,
    viewModel: CornerBowfrontCalculatorViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        topBar = {
            AquariumTopBar(
                title = stringResource(R.string.cornerbowfront_title),
        ...
        Column(
            ...
            InfoFieldWithErrorAndIcon(
                value = state.height,
                onValueChange = {
                    viewModel.onEvent(CornerBowfrontCalculatorEvent.HeightChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                value = state.width,
                onValueChange = {
                    viewModel.onEvent(CornerBowfrontCalculatorEvent.WidthChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                value = state.length,
                onValueChange = {
                    viewModel.onEvent(CornerBowfrontCalculatorEvent.LengthChanged(it))
                },
            ...
            Row(
                ...
                AnimatedVisibility(
                    ...
                    Button(
                        onClick = {
                            viewModel.onEvent(CornerBowfrontCalculatorEvent.ApplyButtonPressed)
                        }
                    ) {
                ...
                Button(
                    onClick = {
                        viewModel.onEvent(CornerBowfrontCalculatorEvent.CalculateButtonPressed)
                    }
                ) {
