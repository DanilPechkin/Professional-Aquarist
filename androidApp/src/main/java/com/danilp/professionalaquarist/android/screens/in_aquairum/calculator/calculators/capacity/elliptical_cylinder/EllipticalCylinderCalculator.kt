...
@Destination
@Composable
fun EllipticalCylinderCalculator(
    navigator: DestinationsNavigator,
    viewModel: EllipticalCylinderCalculatorViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        topBar = {
            AquariumTopBar(
                title = stringResource(R.string.ellipticalcylinder_title),
        ...
        Column(
            ...
            InfoFieldWithErrorAndIcon(
                value = state.height,
                onValueChange = {
                    viewModel.onEvent(EllipticalCylinderCalculatorEvent.HeightChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                value = state.width,
                onValueChange = {
                    viewModel.onEvent(EllipticalCylinderCalculatorEvent.WidthChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                value = state.length,
                onValueChange = {
                    viewModel.onEvent(EllipticalCylinderCalculatorEvent.LengthChanged(it))
                },
            ...
            Row(
                ...
                AnimatedVisibility(
                    ...
                    Button(
                        onClick = {
                            viewModel.onEvent(EllipticalCylinderCalculatorEvent.ApplyButtonPressed)
                        }
                    ) {
                ...
                Button(
                    onClick = {
                        viewModel.onEvent(EllipticalCylinderCalculatorEvent.CalculateButtonPressed)
                    }
                ) {
