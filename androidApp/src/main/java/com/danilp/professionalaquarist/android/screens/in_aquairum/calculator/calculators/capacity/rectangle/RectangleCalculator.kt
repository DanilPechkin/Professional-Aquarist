...
fun RectangleCalculator(
    ...
    viewModel: RectangleCalculatorViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        topBar = {
            AquariumTopBar(
                title = stringResource(R.string.rectangle_title),
        ...
        Column(
            ...
            Row(
                ...
                AnimatedVisibility(
                    ...
                    Button(
                        onClick = {
                            viewModel.onEvent(RectangleCalculatorEvent.ApplyButtonPressed)
                        }
                    ) {
                ...
                Button(
                    onClick = {
                        viewModel.onEvent(RectangleCalculatorEvent.CalculateButtonPressed)
                    }
                ) {
