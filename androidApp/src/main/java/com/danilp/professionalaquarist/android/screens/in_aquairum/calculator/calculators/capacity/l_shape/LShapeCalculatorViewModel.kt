...
@HiltViewModel
class LShapeCalculatorViewModel @Inject constructor(
    ...
    var state by mutableStateOf(LShapeCalculatorState())
        ...
        state = state.copy(
            outputCapacity = convertLiters.to(
                ...
                liters = convertLiters.from(
                    ...
                    value = calculateCapacity.lShape(
