...
@Destination
@Composable
fun LShapeCalculator(
    navigator: DestinationsNavigator,
    viewModel: LShapeCalculatorViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        topBar = {
            AquariumTopBar(
                title = stringResource(R.string.lshape_title),
        ...
        Column(
            ...
            InfoFieldWithErrorAndIcon(
                value = state.height,
                onValueChange = {
                    viewModel.onEvent(LShapeCalculatorEvent.HeightChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                value = state.width,
                onValueChange = {
                    viewModel.onEvent(LShapeCalculatorEvent.WidthChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                ...
                onValueChange = {
                    viewModel.onEvent(LShapeCalculatorEvent.FullWidthChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                value = state.length,
                onValueChange = {
                    viewModel.onEvent(LShapeCalculatorEvent.LengthChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                ...
                onValueChange = {
                    viewModel.onEvent(LShapeCalculatorEvent.FullLengthChanged(it))
                },
            ...
            Row(
                ...
                AnimatedVisibility(
                    ...
                    Button(
                        onClick = {
                            viewModel.onEvent(LShapeCalculatorEvent.ApplyButtonPressed)
                        }
                    ) {
                ...
                Button(
                    onClick = {
                        viewModel.onEvent(LShapeCalculatorEvent.CalculateButtonPressed)
                    }
                ) {
