...
@Destination
@Composable
fun BullnoseCalculator(
    navigator: DestinationsNavigator,
    viewModel: BullnoseCalculatorViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        topBar = {
            AquariumTopBar(
                title = stringResource(R.string.bullnose_title),
        ...
        Column(
            ...
            InfoFieldWithErrorAndIcon(
                value = state.height,
                onValueChange = {
                    viewModel.onEvent(BullnoseCalculatorEvent.HeightChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                value = state.width,
                onValueChange = {
                    viewModel.onEvent(BullnoseCalculatorEvent.WidthChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                value = state.length,
                onValueChange = {
                    viewModel.onEvent(BullnoseCalculatorEvent.LengthChanged(it))
                },
            ...
            Row(
                ...
                AnimatedVisibility(
                    ...
                    Button(
                        onClick = {
                            viewModel.onEvent(BullnoseCalculatorEvent.ApplyButtonPressed)
                        }
                    ) {
                ...
                Button(
                    onClick = {
                        viewModel.onEvent(BullnoseCalculatorEvent.CalculateButtonPressed)
                    }
                ) {
