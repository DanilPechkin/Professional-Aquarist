...
@Destination
@Composable
fun TrapezoidCalculator(
    navigator: DestinationsNavigator,
    viewModel: TrapezoidCalculatorViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        topBar = {
            AquariumTopBar(
                title = stringResource(R.string.trapezoid_title),
        ...
        Column(
            ...
            InfoFieldWithErrorAndIcon(
                value = state.height,
                onValueChange = {
                    viewModel.onEvent(TrapezoidCalculatorEvent.HeightChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                value = state.width,
                onValueChange = {
                    viewModel.onEvent(TrapezoidCalculatorEvent.WidthChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                ...
                onValueChange = {
                    viewModel.onEvent(TrapezoidCalculatorEvent.FullWidthChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                value = state.length,
                onValueChange = {
                    viewModel.onEvent(TrapezoidCalculatorEvent.LengthChanged(it))
                },
            ...
            Row(
                ...
                AnimatedVisibility(
                    ...
                    Button(
                        onClick = {
                            viewModel.onEvent(TrapezoidCalculatorEvent.ApplyButtonPressed)
                        }
                    ) {
                ...
                Button(
                    onClick = {
                        viewModel.onEvent(TrapezoidCalculatorEvent.CalculateButtonPressed)
                    }
                ) {
