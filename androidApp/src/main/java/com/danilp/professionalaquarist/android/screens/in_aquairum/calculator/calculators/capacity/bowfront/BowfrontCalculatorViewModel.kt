...
@HiltViewModel
class BowfrontCalculatorViewModel @Inject constructor(
    ...
    fun onEvent(event: BowfrontCalculatorEvent) {
        when (event) {
            BowfrontCalculatorEvent.CalculateButtonPressed -> {
        ...
        state = state.copy(
            outputCapacity = convertLiters.to(
                ...
                liters = convertLiters.from(
                    ...
                    value = calculateCapacity.bowfront(
