...
fun CylinderCalculator(
    ...
    viewModel: CylinderCalculatorViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        ...
        Column(
            ...
            InfoFieldWithErrorAndIcon(
                value = state.height,
                onValueChange = {
                    viewModel.onEvent(CylinderCalculatorEvent.HeightChanged(it))
                },
            ...
            InfoFieldWithErrorAndIcon(
                ...
                onValueChange = {
                    viewModel.onEvent(CylinderCalculatorEvent.DiameterChanged(it))
                },
            ...
            Row(
                ...
                AnimatedVisibility(
                    ...
                    Button(
                        onClick = {
                            viewModel.onEvent(CylinderCalculatorEvent.ApplyButtonPressed)
                        }
                    ) {
                ...
                Button(
                    onClick = {
                        viewModel.onEvent(CylinderCalculatorEvent.CalculateButtonPressed)
                    }
                ) {
